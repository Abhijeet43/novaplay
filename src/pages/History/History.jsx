...
import { getHistory, deleteAllHistory } from "../../utils";
...
const History = () => {
  ...
  useEffect(() => getHistory(token, historyDispatch), [historyDispatch, token]);

  const reversedVideos = history.length > 0 ? [...history].reverse() : "";
        ...
        {history.length > 0 ? (
          <>
            <button
              ...
              onClick={() => deleteAllHistory(token, historyDispatch)}
            >
            ...
            <div className="video-card-listing-container">
              ...
              />
              <VideoList videos={reversedVideos} />
            </div>
          </>
        ) : (
          <div className="history-empty-container">
            ...
            >
              Watch Some Videos to see them in History
            </button>
          </div>
        )}
      </section>
